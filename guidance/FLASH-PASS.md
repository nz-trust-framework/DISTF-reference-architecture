...
![Image 1: Flash pass example on device. Image 2: Example of person presenting flash pass credential.](../media/flash_pass_image_12.jpg)

*Image 1: Flash pass example on device.*
...
Facilitation services should allow credential holders to view their personal information contained within credentials issued to them. However, this should be provided in a format clearly intended for personal reference only, not as proof for third parties.
