...
The RA covers end‑to‑end processes and data flows associated with identity proofing and enrolment, authentication, credential issuance, binding, credential presentation, revocation, and the ongoing management of trust. It also describes the trust and governance mechanisms, such as trust lists, together with the security, privacy, and assurance controls required for a functioning digital identity ecosystem. Where relevant, the RA provides guidance on the application of international standards in a New Zealand context.
